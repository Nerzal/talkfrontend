...
function ActivePresenterView({ talk }: { talk: Talk }) {
  ...
  const { slideIndex, stepIndex, isFirst, isLast, goNext, goPrev, goBack } = useTalkPresenter(
    talk,
    {
      onExit,
    },
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 flex-1 min-h-0">
        ...
        <div className="flex flex-col gap-4 min-h-0">
          ...
          <div className="flex-1 min-h-0 flex flex-col">
            ...
            <div className="mt-2 flex-1 min-h-[6rem] overflow-y-auto rounded bg-slate-900 p-3 text-slate-300 whitespace-pre-wrap text-sm">
